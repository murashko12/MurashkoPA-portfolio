const Contact = () => {
    return (
        <div className="w-[70%] mx-auto h-auto">
            ...
            <br />
            <p className="text-justify text-slate-100 font-semibold font-lg">Submit the form below to get touch with me</p>
            <br />
            <div className="flex justify-center">
                <form className="flex flex-col w-full gap-4 lg:w-6/12" action="https://getform.io/f/8904d217-2f6a-4311-a35c-3d56ae444fe9" method="POST">
                    ...
                    <button className="text-[#288499] bg-slate-100 p-3 rounded-xl w-full font-black text-lg mx-auto md:w-6/12">Let's talk</button>
                </form>
            </div>
        </div>
    )
